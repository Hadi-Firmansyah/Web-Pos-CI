		...
		<div class="container-fluid">
			...
			<div class="d-sm-flex align-items-center justify-content-between mb-4">
				<h1 class="h2 mb-0 text-gray-800">Order</h1>
			</div>
				...
				<?php
          		...
          		?>
					<tr>
						...
						<td>
							<div>
							<a href="<?php echo site_url('Order/order_edit/'.$datas->id);?>">
									<button class="btn btn-info" style="width:100%;">Edit</button></a>
							</div>
							<div class="mt-2">
								<a href="<?php echo site_url('Order/order_delete/'.$datas->id);?>">
